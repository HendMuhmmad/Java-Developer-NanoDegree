...
public class CarService {
     ...
     * @throws CarNotFoundException if no car matches the id provided
     */
    ...
    public Car save(Car car) {
        ...
        newCar.setPrice(priceClient.getPrice(newCar.getId()));
        newCar.setLocation(mapsClient.getAddress(car.getLocation()));
        return newCar;
    }
